...
/* Android: open using fd from UsbDeviceConnection.getFileDescriptor().
 * errmsg is populated with a human-readable failure reason on error. */
RTLSDR_API int rtlsdr_open_android(rtlsdr_dev_t **dev, int fd,
